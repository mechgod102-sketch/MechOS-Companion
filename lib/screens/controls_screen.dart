...
class ControlsScreen extends StatelessWidget {
  ...
  Future<void> _confirm(BuildContext context, String title, String detail, String action, {String? value}) async {
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(title: const Text('MechOS Controls')),
        body: ListView(padding: const EdgeInsets.all(16), children: [
          ...
          const SizedBox(height: 10),
          ActionCard(icon: Icons.restart_alt, title: 'Restart MechOS', subtitle: 'Restart the paired computer', danger: true, onTap: () => _confirm(context, 'Restart MechOS?', 'Unsaved work on the paired device can be lost.', 'restart')),
          const SizedBox(height: 10),
          ActionCard(icon: Icons.power_settings_new, title: 'Shut down MechOS', subtitle: 'Power off the paired computer', danger: true, onTap: () => _confirm(context, 'Shut down MechOS?', 'Unsaved work on the paired device can be lost.', 'shutdown')),
        ]),
      );
}
